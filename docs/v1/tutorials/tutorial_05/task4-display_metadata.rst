...
..  list-table::
    ...
    * - **Fetch Manifest**
      - `GET {urn}/manifest`_
      - Returns information about the derivatives of a specified source file, including output URNs and statuses.
    * - **List Model Views**
      - `GET {urn}/metadata`_
      - Returns the model view IDs for a model.
    * - **Fetch Object Tree**
      - `GET {urn}/metadata/{modelGuid}`_
      - Returns the hierarchical object tree of a specified model view.
    * - **Fetch All Properties**
      - `GET {urn}/metadata/{modelGuid}/properties`_
      - Returns all properties of specified objects in a model view.
    * - **Fetch Specific Properties**
      - `POST {urn}/metadata/{modelGuid}/properties:query <en/docs/model-derivative/v2/reference/http/urn-metadata-guid-properties-query-POST>`_
      - Returns specified properties of specified objects in a specified model view.


.. _GET formats: en/docs/model-derivative/v2/reference/http/formats-GET
.. _POST job: en/docs/model-derivative/v2/reference/http/job-POST
.. _POST references: en/docs/model-derivative/v2/reference/http/urn-references-POST
.. _GET {urn}/manifest: en/docs/model-derivative/v2/reference/http/urn-manifest-GET
.. _DELETE {urn}/manifest: en/docs/model-derivative/v2/reference/http/urn-manifest-DELETE
.. _GET {urn}/manifest/{derivativeUrn}: en/docs/model-derivative/v2/reference/http/urn-manifest-derivativeurn-GET
.. _HEAD {urn}/manifest/{derivativeUrn): en/docs/model-derivative/v2/reference/http/urn-manifest-derivativeurn-HEAD
.. _GET {urn}/manifest/{derivativeUrn}/signedcookies: /en/docs/model-derivative/v2/reference/http/urn-manifest-derivativeUrn-signedcookies-GET
.. _GET {urn}/metadata: en/docs/model-derivative/v2/reference/http/urn-metadata-GET
.. _GET {urn}/metadata/{modelGuid}: en/docs/model-derivative/v2/reference/http/urn-metadata-guid-GET
.. _GET {urn}/metadata/{modelGuid}/properties: en/docs/model-derivative/v2/reference/http/urn-metadata-guid-properties-GET
.. _GET {urn}/thumbnail: en/docs/model-derivative/v2/reference/http/urn-thumbnail-GET
.. _POST {urn}/references: en/docs/model-derivative/v2/reference/http/urn-references-POST/
.. _POST {urn}/metadata/{modelGuid}/properties:query: en/docs/model-derivative/v2/reference/http/urn-metadata-guid-properties-query-POST
...
Note: Although the Revit file used in this tutorial contains multiple model views, Fusion 360 and Inventor models contain only a single model view.
